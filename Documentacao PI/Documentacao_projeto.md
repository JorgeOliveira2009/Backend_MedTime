# 📱 MedTime — Documentação do Projeto

## O que é esse projeto?

O MedTime é um **backend** para um aplicativo de lembrete de medicamentos.
O usuário cadastra os remédios que precisa tomar, com o horário, e marca quando tomou.
